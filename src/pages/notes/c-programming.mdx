...
int main() {
    ...
    char char1;
    iss.get(char1);
    std::cout << "Character read after seeking to absolute position 7: " << char1 << std::endl; 
    // Output: o

    iss.seekg(6, std::ios::beg); 
    std::string word1;
    iss >> word1;
    std::cout << "Word read after seeking from beginning: " << word1 << std::endl; 
    // Output: World

    iss.seekg(-2, std::ios::cur); 
    char char2;
    iss.get(char2);
    std::cout << "Character read after seeking from current: " << char2 << std::endl; 
    // Output: d

    iss.seekg(-5, std::ios::end); 
    std::string word2;
    iss >> word2;
    std::cout << "Word read after seeking from end: " << word2 << std::endl; 
    // Output: World
...
<p styke="color:BlueViolet">Example</p>
