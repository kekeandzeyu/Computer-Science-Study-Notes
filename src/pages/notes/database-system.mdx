...
collection of records, and each record contains a collection of records. 
...
* **Disk space manager (on disk):** Pages read/written t physical disk/files.
...
For DBMS files, there are mainly four file structures:
